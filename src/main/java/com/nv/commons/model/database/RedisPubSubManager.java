...
public class RedisPubSubManager {
	...
	private static final RedisPubSubManager redisManager = new RedisPubSubManager();
	...
	public static void init() {
		try {
			...
			LogUtils.err.error("RedisPubSubManager", e);
	...
	public void initClient() {
		try (InputStream in = RedisPubSubManager.class
			.getResourceAsStream("/redisSentinel_encrypt.property")) {
